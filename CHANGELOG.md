...
### Changed
- docs: update demo link to HF Spaces direct URL

## [1.2.13] - 2026-03-11

### Fixed
- move CREDENTIALS_FILE to config module to fix import-order bug
...
### Fixed
- restrict docs workflow to master branch only

### Changed
- Merge branch 'desktop' of github.com:TavoloPerUno/py_visualize_accelerometry into desktop
- chore: rename desktop to master in all workflows

## [1.2.10] - 2026-03-11

### Fixed
- add desktop branch and workflow_dispatch to docs workflow
...
### Fixed
- use --index and absolute paths in Dockerfile for HF Spaces
...
### Fixed
- use absolute /login path in login form action
...
### Fixed
- revert to plain text demo passwords
...
[1.2.13]: https://github.com/TavoloPerUno/py_visualize_accelerometry/compare/v1.2.12...v1.2.13

[1.2.14]: https://github.com/TavoloPerUno/py_visualize_accelerometry/compare/v1.2.13...v1.2.14
